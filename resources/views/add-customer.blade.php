                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row g-3 align-items-center">
                                                <div class="col-4">
                                                    <label for="fullname" class="col-form-label fw-semibold" id=""
                                                        data-id="">Full Name <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-8">
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="row g-3 align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="code" class="form-control" aria-describedby=""
                                                        id="" data-id="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="row g-3 align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="phone" class="form-control" aria-describedby=""
                                                        id="" data-id="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-4">
                                                    <label for="bussinessnumber" class="col-form-label fw-semibold" id=""
                                                        data-id="">Business Number</label>
                                                </div>
                                                <div class="col-8">
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="row g-3 align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="owner" class="form-control" aria-describedby=""
                                                        id="" data-id="" placeholder="Richard" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6 mb-3">
                                        ...
                                        <div class="col-6 mb-3">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-4">
                                                    <label for="confirmpassword" class="col-form-label fw-semibold" id=""
                                                        data-id="">Confirm Password</label>
                                                </div>
                                                <div class="col-8">
